...
class AppColors {
  ...
  static const Color background = Color(0xFF051525); // Very dark blue background
  static const Color surface = Color(0xFF071E34); // Darker surface
  static const Color cardBackground = Color(0xFF081A2C); // Darker card background
  ...
  static const Color error = Color(0xFFE53935); // Red for error states (negative amounts)
  static const Color borderPrimary = Color(0xFF1E3A5F); // Medium blue for borders
  
  // Additional colors from the screenshot
  static const Color categoryBills = Color(0xFF0E9BB6); // Teal for bills category
  static const Color categoryTransport = Color(0xFF127FA0); // Blue for transport category
  static const Color categoryShopping = Color(0xFF1AA1C0); // Light blue for shopping category
  static const Color insightBackground = Color(0xFF102C4C); // Background for insights
  
  // Gradients
  static const Color gradientStart = Color(0xFF041220); // Very dark blue gradient start
  ...
  static const Color buttonGradientEnd = Color(0xFF34B4FF); // Vibrant light blue button gradient end
}
...
//     0xFF4A90E2,
//   ); // Teal-blue for primary elements
//   static const Color secondary = Color(0xFF50C878); // Teal-green for accents
//   static const Color background = Color(0xFF1E2A44); // Dark blue background
...
//     0xFFFFB74D,
//   ); // Soft amber for success messages
//   static const Color textPrimary = Colors.white; // White for primary text
